...
SupportBot.prototype.startCrons = function(){
    ...
    new cronJob("0 0 19,21 * * mon-fri",this.setAgentOnDuty.bind(this,"Robert"),null,true);
    new cronJob("0 0 8,20,23 * * mon-fri",this.getAgentOnDuty.bind(this),null,true);
...
SupportBot.prototype.setAgentOnDuty = function(name){
    var u = config.users[name.toLowerCase()];
    this.setSailbotOnDuty("!ondutycs "+u.name+"<"+u.phone+">");
    console.log("Setting "+name+" on duty.");
};
