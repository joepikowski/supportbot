...
SupportBot.prototype.startCrons = function(){
    ...
    new cronJob("0 0 20 * * mon-fri",this.setAgentOnDuty.bind(this,"Elle"),null,true);
    new cronJob("0 0 10,23 * * mon-fri",this.getAgentOnDuty.bind(this),null,true);
