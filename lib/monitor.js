...
Monitor.prototype.ongoingIRCAlert = function(checkItem){
    ...
    this.setOne("output","[ALERT] Stability Check for "+checkItem+" failing since "+start.format("LT")+" after "+this.retries[checkItem]+" retries.");
    this.ircOutputResult();
};
...
Monitor.prototype.resolveIRCAlert = function(checkItem){
    ...
    this.setOne("output","[RESOLVED] Stability Check for "+checkItem+" resolved after "+this.getOutageTime(checkItem)+" minutes.");
    this.ircOutputResult();
};
...
Monitor.prototype.checkFeed = function(callback){
    var request = RequestModel({
        ...
        protocol: "HTTP",
        hostname: "cb.sailthru.com",
        path: "/ws/feed?id=5102fc9731bf405a76000006",
...
Monitor.prototype.checkHorizon = function(callback){
    var request = RequestModel({
        method: "GET",
        protocol: "HTTP",
        hostname: "horizon.businessinsider.com",
        path: "/horizon/recommend?number=5",
