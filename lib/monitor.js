...
Monitor.prototype.chatCheck = function(callback){
    this.setOne("chatCallback",callback);
...
Monitor.prototype.handleError = function(checkItem,err){
    ...
    if (this.inMonitor(c)){
        ...
        this.retries[c] % 20 === 0 ? this.ongoingChatAlert(c) : true;
    }else{
        this.addToMonitor(checkItem,now);
        this.newChatAlert(checkItem);
    }
    this.retries[c]++;
};  
...
Monitor.prototype.newChatAlert = function(checkItem){
...
Monitor.prototype.ongoingChatAlert = function(checkItem){
...
Monitor.prototype.resolveChatAlert = function(checkItem){
...
Monitor.prototype.chatOutputResult = function(){
