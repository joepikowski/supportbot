...
function GoogleCal(){
    ...
    this.oauth2Client.refreshAccessToken(this.authCheck);
...
GoogleCal.prototype.authCheck = function(err){
    if (err){
        console.log("[Error] Problem Refreshing OAuth2 Tokens.")
    }
};
